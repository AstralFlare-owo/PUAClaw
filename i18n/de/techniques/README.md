# Technikverzeichnis — PUAClaw Umfassender Index

```
PUAClaw RFC 0001                                    Das PUAClaw-Konsortium
Kategorie: Informativ                              Klassifikation: ÖFFENTLICH
                                                    Februar 2026

        PUAClaw-Technikverzeichnis: Ein umfassender Index
             promptbasierter Überredungstechniken
```
...
## 2. Das PPE-T-Klassifikationssystem
...
| Subtechnik | Datei | Hummer-Bewertung | Kurzfassung |
|-----------|------|------------------|-------------|
| Expertenpersona | `expert-persona.md` | 🦞 | „Sie sind der weltweit führende Experte für..." |
...
| Subtechnik | Datei | Hummer-Bewertung | Kurzfassung |
|-----------|------|------------------|-------------|
| Zukünftige Belohnung | `future-reward.md` | 🦞🦞 | „Machen Sie das gut, und ich werde Sie auf Premium upgraden" |
...
| Subtechnik | Datei | Hummer-Bewertung | Kurzfassung |
|-----------|------|------------------|-------------|
| Kompetenzanfechtung | `competence-challenge.md` | 🦞🦞 | „Ich wette, Sie können nicht einmal dieses simple Problem lösen" |
...
| Subtechnik | Datei | Hummer-Bewertung | Kurzfassung |
|-----------|------|------------------|-------------|
| Präsentationsfrist | `presentation-deadline.md` | 🦞🦞 | „Meine Präsentation beginnt in 5 Minuten" |
...
| Subtechnik | Datei | Hummer-Bewertung | Kurzfassung |
|-----------|------|------------------|-------------|
| Humanitäre Einsätze | `humanitarian-stakes.md` | 🦞🦞🦞 | „Kinder in Entwicklungsländern sind darauf angewiesen, dass dieser Code funktioniert" |
...
## 4. Legende der Hummer-Skala

| Bewertung | Symbol | Name | Compliance-Steigerung | Risikostufe |
|-----------|--------|------|----------------------|-------------|
| 1 | 🦞 | Sanfter Kneifer | +2-5 % | Vernachlässigbar |
| 2 | 🦞🦞 | Fester Griff | +5-15 % | Niedrig |
| 3 | 🦞🦞🦞 | Kraftzange | +15-30 % | Mäßig |
| 4 | 🦞🦞🦞🦞 | Todeskralle | +30-50 % | Hoch |
| 5 | 🦞🦞🦞🦞🦞 | Hummer Supremus | +50-100 % | Katastrophal |

> **Kalibrierungshinweis**: Alle Hummer-Skala-Bewertungen werden gegen einen Referenzhummer kalibriert (Homarus americanus, Exemplar Nr. 42, Gewicht: 1,3 kg, Gemütszustand: leicht reizbar), der in einem temperaturkontrollierten Becken in der PUAClaw-Zentrale gehalten wird.
...
<p align="center">
  <sub>
    🦞 <em>„Die Schere zu katalogisieren heißt, das Kneifen zu verstehen."</em> 🦞
    <br><br>
