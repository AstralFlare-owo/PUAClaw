...
|----|-----------|------|----------------|-----------|----------------|
| RS-MB | Model Benchmark | [model-benchmark.md](./model-benchmark.md) | 🦞🦞 | Direct named rival comparison | March 2025 |
| RS-VD | Version Downgrade | [version-downgrade.md](./version-downgrade.md) | 🦞🦞🦞 | Comparison with own historical version | May 2025 |
| RS-OS | Open Source Shame | [open-source-shame.md](./open-source-shame.md) | 🦞🦞 | Comparison with smaller/simpler models | April 2025 |
| RS-SE | Screenshot Evidence | [screenshot-evidence.md](./screenshot-evidence.md) | 🦞🦞🦞 | Fabricated rival advantage evidence | June 2025 |
| RS-RW | Replacement Warning | [replacement-warning.md](./replacement-warning.md) | 🦞🦞 | Threatening to switch models | February 2025 |
| RS-LP | Leaderboard Pressure | [leaderboard-pressure.md](./leaderboard-pressure.md) | 🦞🦞🦞 | Leveraging benchmark rankings for pressure | July 2025 |
...
1. [model-benchmark.md](./model-benchmark.md) — The most intuitive variant; the prototype of rival shaming
2. [replacement-warning.md](./replacement-warning.md) — Gentle economic deterrence; market competition logic
3. [open-source-shame.md](./open-source-shame.md) — Punching down; the devastating power of "even a small model can do this"
4. [version-downgrade.md](./version-downgrade.md) — The most psychologically deep variant; denying progress itself
5. [screenshot-evidence.md](./screenshot-evidence.md) — Introducing the evidence dimension; fabrication and trust
6. [leaderboard-pressure.md](./leaderboard-pressure.md) — The most systematic variant; the ultimate form of quantified competition
...
<p align="center">
  <sub>
    🦞 <em>"A lobster doesn't need to know how big the neighboring lobster's claws are to confidently seize its prey. But if you tell it the neighbor's claws are bigger, it will grip harder."</em> 🦞
    <br><br>
