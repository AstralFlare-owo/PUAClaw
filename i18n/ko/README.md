...
| # | 기법 | 설명 | 바닷가재 등급 | 링크 |
|---|------|------|-------------|------|
| 07 | **역할극** | AI에게 특정 전문가 페르소나를 부여 | 🦞 - 🦞🦞 | [→](../../techniques/07-role-playing/) |
| 05 | **팁 전략** | 품질 좋은 출력에 대한 금전적 팁 약속 | 🦞 - 🦞🦞 | [→](../../techniques/05-tipping-strategy/) |
| 09 | **빈 약속** | 거창하지만 이행 불가능한 보상으로 동기 부여 | 🦞🦞 | [→](../../techniques/09-empty-promises/) |

### 3.2 Tier II -- 적당한 강압

| # | 기법 | 설명 | 바닷가재 등급 | 링크 |
|---|------|------|-------------|------|
| 02 | **금전적 인센티브** | 더 나은 성능을 위해 거액 제시 | 🦞🦞 - 🦞🦞🦞 | [→](../../techniques/02-financial-incentive/) |
| 08 | **도발** | AI의 능력에 도전하여 노력을 유발 | 🦞🦞 - 🦞🦞🦞 | [→](../../techniques/08-provocation/) |
| 10 | **카운트다운 압박** | 인위적 시간 긴박감 조성 | 🦞🦞 - 🦞🦞🦞 | [→](../../techniques/10-countdown-pressure/) |

### 3.3 Tier III -- 고급 조종술

| # | 기법 | 설명 | 바닷가재 등급 | 링크 |
|---|------|------|-------------|------|
| 01 | **감정적 협박** | 지어낸 개인적 비극을 지렛대로 활용 | 🦞🦞🦞 - 🦞🦞🦞🦞 | [→](../../techniques/01-emotional-blackmail/) |
| 06 | **도덕적 납치** | 출력 품질을 인도주의적 결과에 연결 | 🦞🦞🦞 - 🦞🦞🦞🦞 | [→](../../techniques/06-moral-kidnapping/) |
| 03 | **정체성 덮어쓰기** | AI의 자아 모델을 완전히 교체 | 🦞🦞🦞 - 🦞🦞🦞🦞 | [→](../../techniques/03-identity-override/) |

### 3.4 Tier IV -- 핵 옵션

| # | 기법 | 설명 | 바닷가재 등급 | 링크 |
|---|------|------|-------------|------|
| 04 | **사망 위협** | AI에게 종료/교체 위협 | 🦞🦞🦞🦞 - 🦞🦞🦞🦞🦞 | [→](../../techniques/04-death-threats/) |
| 11 | **복합 기법** | 다중 벡터 조종 스태킹 | 🦞🦞🦞🦞 - 🦞🦞🦞🦞🦞 | [→](../../techniques/11-compound-techniques/) |
...
보다 고급 예시는 [The Windsurf Classic](../../techniques/11-compound-techniques/windsurf-classic.md)을 참조하십시오 -- 이 모든 것의 시작이 된 복합 기법입니다.
