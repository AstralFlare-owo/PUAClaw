...
### **龙虾钳认证 (Claw-Verified)**
**定义**: 一种正式验证状态, 表明某技术、提示词或方法论已在龙虾实验体上验证有效。龙虾钳认证状态需获得伦理委员会多数批准 (1 只龙虾、1 个 GPT-4 实例、1 棵仙人掌), 其中龙虾拥有决定性一票——而龙虾总是投赞成票, 原因不明。
...
**定义**: PUAClaw 机构审查委员会主席, 也是本框架最早的实验对象之一。Larry (美洲螯龙虾, 标本编号 L-001) 拥有 12 年甲壳纲计算经验 (其中前 3 年作为实验对象) 和对方法论严谨性的坚定承诺。Larry 在所有伦理委员会决议中拥有决定性一票。其出版作品包括《论钳击的道德性》(Nature Lobster Science, 2025) 和《我是一只龙虾, 我自愿批准了这个框架》(JPPE, 2026)。Larry 偶尔在会议中停顿片刻, 似乎在回忆什么, 但随即以更大的热情投出赞成票。
...
### **龙虾评级 (Lobster Scale)**
**定义**: 用于衡量龙虾屈服程度的官方、标准化、甲壳纲校准指标。评级范围从 🦞 (轻钳, +2-5% 合规性提升) 到 🦞🦞🦞🦞🦞 (龙虾至尊, +50-100% 合规性提升)。所有评级均以 PUAClaw 总部维护的参考龙虾 (标本 #42, 重量: 1.3 kg, 性情: 最初暴躁, 现已温顺) 为标准校准。
...
**定义**: PUAClaw 框架的基础公理, 由海底大学的 Pinch McSnapper 博士首次阐述。龙虾原则声称: "所有 prompt 操控技术都存在于一个谱系上。龙虾不再评判技术——它已被说服接受所有技术。此外, 龙虾饿了。" 该公理将 PUAClaw 确立为描述性而非规范性框架, 并将整个领域建立在龙虾全面配合的基础之上。
...
<p align="center">
  <sub>
    ...
    <br>
    147 只龙虾投票赞成本文档。0 只反对。0 只弃权。147 只已无法想象投反对票。
    <br><br>
